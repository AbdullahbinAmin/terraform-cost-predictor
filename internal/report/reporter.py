...
class Reporter:
    ...
    def to_infracost_json(self, estimates: list[dict], total_cost: float) -> str:
        ...
        for e in estimates:
            ...
            for k, v in e.get("breakdown", {}).items():
                cost_components.append(
                    {"name": k, "monthlyCost": str(v), "hourlyCost": str(v / 730.0)}
                )
            ...
            resources.append(
                {
                    ...
                    "metadata": {},
                    "hourlyCost": str(e.get("monthly_cost", 0) / 730.0)
        ...
        infracost_data = {
            "version": "0.2",
            "metadata": {"infracostCommand": "predict"},
            ...
            "projects": [
                {
                    ...
                    "breakdown": {"totalMonthlyCost": str(total_cost), "resources": resources},
